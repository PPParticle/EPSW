...
// 数据量 = L1 cache 长指令速度>短指令组合 
// L1 cache < 数据量 <= 3*L1 cache 长指令速度和短指令组合之间没有明显区别
// 3*L1 cache < 数据量 短指令组合速度>长指令 特别是 e32m2
#include <iostream>
...
int main(int argc, char **argv)
{
    ...
    {   
        ...
        for (int i = n/4; i > 0; i -= vl)
        {
            ...
            vsev_int32xm8((int32_t*)tmp_8, v8, vl);
            tmp_8 += vl;
            tmp += vl;
        }
    }
    ...
    {   
        ...
        {   
            ...
            if (i - 2 * vl > 0)
            {
                ...
                vsev_int32xm4((int32_t*)tmp_4, v40, vl);
                vsev_int32xm4((int32_t*)(tmp_4 + vl), v41, vl);
                tmp_4 += 2 * vl;
                tmp += 2 * vl;
                i -= 2 * vl;
            }
    ...
    for (int i = 0; i < num; i++)
    {
        ...
        {   
            ...
            if (i - 4 * vl > 0)
            {
                ...
                vsev_int32xm2((int32_t*)tmp_2, v20, vl);
                vsev_int32xm2((int32_t*)(tmp_2 + vl), v21, vl);
                vsev_int32xm2((int32_t*)(tmp_2 + 2 * vl), v22, vl);
                vsev_int32xm2((int32_t*)(tmp_2 + 3 * vl), v23, vl);
                tmp_2 += 4 * vl;
                tmp += 4 * vl;
                i -= 4 * vl;
            }
    ...
    {   
        ...
        for (int i = n/4; i > 0;)
        {
            ...
            if (i - 8 * vl > 0)
            {
                ...
                vsev_int32xm1((int32_t*)tmp_1, v10, vl);
                vsev_int32xm1((int32_t*)(tmp_1 + vl), v11, vl);
                vsev_int32xm1((int32_t*)(tmp_1 + 2 * vl), v12, vl);
                vsev_int32xm1((int32_t*)(tmp_1 + 3 * vl), v13, vl);
                vsev_int32xm1((int32_t*)(tmp_1 + 4 * vl), v14, vl);
                vsev_int32xm1((int32_t*)(tmp_1 + 5 * vl), v15, vl);
                vsev_int32xm1((int32_t*)(tmp_1 + 6 * vl), v16, vl);
                vsev_int32xm1((int32_t*)(tmp_1 + 7 * vl), v17, vl);
                tmp_1 += 8 * vl;
                tmp += 8 * vl;
                i -= 8 * vl;
            }
