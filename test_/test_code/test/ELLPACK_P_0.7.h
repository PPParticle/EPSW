...
public:
    ...
    void init(unsigned int rows, Val **rowPtr, unsigned int **coordPtr, unsigned int *nnz_num, unsigned int *nnz_old_num,
    ...
    ELLPACK_P(unsigned int rows, Val **rowPtr, unsigned int **coordPtr, unsigned int *nnz_num, unsigned int *nnz_old_num,
              unsigned int *rowidx, unsigned int nnz, unsigned int strips)
    {
